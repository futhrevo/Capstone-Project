...
public class OtpFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String selection = "body LIKE ? OR body LIKE ? OR body LIKE ?";  //"body REGEXP ?";
        String[] selectionArgs = {"%OTP%", "%verification code%", "%One Time Password%"}; // {".*OTP.*"}
//        String selectionArgs = "WHERE x REGEXP <regex>";
        // Fetch Inbox SMS Message from Built-in Content Provider
        Cursor c = cr.query(inboxURI, reqCols, selection, selectionArgs, null);
        Utils.updatePrefValues(c,OTPINDICES, getActivity());
